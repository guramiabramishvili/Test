...
<html>
    ...
    <input id="radio" type="radio" name="testType" value="oneAns" checked>ერთპასუხიანი ტესტი <br>
    <input id="radio" type="radio" name="testType" value="multiAns">რამდენიმეპასუხიანი ტესტი <br>
    <input id="radio" type="radio" name="testType" value="open">ღია შეკითხვა <br>
